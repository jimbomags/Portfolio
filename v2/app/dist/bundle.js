...
var skills = _react2.default.createElement(
  ...
  _react2.default.createElement(
    ...
    _Content2.default.skills.map(function (item) {
      return _react2.default.createElement(
        'div',
        { key: item[0], className: 'skills' },
        _react2.default.createElement('img', { src: item[1] }),
        item[2]
      );
    })
  )
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.state = {
      content: _Content2.default.home
    };
    return _this;
  }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _Content2.default.home
        ),
        _Content2.default.about,
        skills,
        _Content2.default.portfolio,
        _Content2.default.contact
      );
    }
  }]);
...
var Content = {
  ...
  about: _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'p',
        null,
        'Hi, I\u2019m James, and I\u2019m a self-taught Junior Front End Developer. I started learning to code in August 2016 after deciding to change my career. I began by looking at my interests for inspiration and two things stood out, video games and tech. I immediately ruled out playing video games as I normally get thrashed when I play online \u2013 so I looked into tech. In deciding what to learn I looked back to when I was studying Computing for my A-levels. I was led to choosing web development when I realised my favourite projects were building a simple website and coding a snakes & ladders game in BASIC.'
      ),
      _react2.default.createElement(
        'h3',
        null,
      ...
      _react2.default.createElement(
        'p',
        null,
        'Once I had an understanding of HTML & CSS I moved onto JavaScript. Initially I used Codecademy and Lynda but was struggling to learn from their JS courses. That led me to search other options and I found FreeCodeCamp. I liked FCC because you learn by writing code to complete challenges. You start small such as declaring variables before moving onto more complex algorithms. Another part of FCC\u2019s syllabus is completing projects, which comprised my first ',
        _react2.default.createElement(
          'a',
          { href: 'https://decorous-glove.surge.sh', target: '_blank' },
          'portfolio.'
        )
      ),
      _react2.default.createElement(
  ...
  skills: [[1, './assets/html5.png', _react2.default.createElement(
    'p',
    null,
    'HTML'
  )], [2, './assets/css3.png', _react2.default.createElement(
    'p',
    null,
    'CSS'
  )], [3, './assets/javascript.png', _react2.default.createElement(
    'p',
    null,
    'Javascript'
  )], [4, './assets/react.jpg', _react2.default.createElement(
    'p',
    null,
    'React'
  )], [5, './assets/node.png', _react2.default.createElement(
    'p',
    null,
    'Node'
  )], [6, './assets/sass.png', _react2.default.createElement(
    'p',
    null,
    'Sass'
  )]],
...
var _SnakesAndLadders = __webpack_require__(36);

var _SnakesAndLadders2 = _interopRequireDefault(_SnakesAndLadders);

var _RndQuote = __webpack_require__(37);

var _RndQuote2 = _interopRequireDefault(_RndQuote);
...
var Portfolio = function (_Component) {
  ...
  _createClass(Portfolio, [{
    key: 'handleState',
    value: function handleState(obj) {
    ...
    value: function render() {
      ...
      var homePortfolio = _react2.default.createElement(
        'div',
        { id: 'portfolio-home' },
        _react2.default.createElement(
          'h2',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('div', { id: 'port-sl', className: 'port-links', onClick: function onClick() {
                _this2.handleState({
                  home: false,
                  sandl: true,
                  weather: false,
          ...
          _react2.default.createElement(
            'div',
            { className: 'link-container' },
            _react2.default.createElement('div', { id: 'port-weather', className: 'port-links', onClick: function onClick() {
                _this2.handleState({
                  home: false,
                  sandl: false,
                  weather: true,
          ...
          _react2.default.createElement(
            'div',
            { className: 'link-container' },
            _react2.default.createElement('div', { id: 'port-quote', className: 'port-links', onClick: function onClick() {
                _this2.handleState({
                  home: false,
                  sandl: false,
                  weather: false,
      ...
      if (this.state.home == true) {
        ...
        display = _react2.default.createElement(_SnakesAndLadders2.default, null);
      } else if (this.state.weather) {
        display = _react2.default.createElement(_Weather2.default, null);
      } else if (this.state.rndQuote) {
        display = _react2.default.createElement(_RndQuote2.default, null);
      }
...
var _myLocation = __webpack_require__(32);
...
var Weather = function (_Component) {
  ...
  function Weather(props) {
    ...
    _this.getLatLong = _this.getLatLong.bind(_this);
    _this.findUserLocation = _this.findUserLocation.bind(_this);
  ...
  _createClass(Weather, [{
    ...
    key: 'getLatLong',
    value: function getLatLong(event) {
      var _this2 = this;
      ...
      try {
        ...
        var encodedAddress = encodeURIComponent(this.state.address);
        var url = 'https://maps.googleapis.com/maps/api/geocode/json?address=' + encodedAddress + '&key=AIzaSyBrX29SqRNyMJOxkzo64rbBDbpBxZASzks';
    ...
    value: function findUserLocation() {
      ...
      var cursor = document.querySelector('#portfolio-container');
      ...
      navigator.geolocation.getCurrentPosition(function (results) {
        ...
        _this3.getWeather(position);
      }, function () {
        cursor.style.cursor = 'default';
        _this3.errorHandler('Unable to locate your position');
      });
    }
  }, {
    key: 'getWeather',
    value: function getWeather(loc) {
      var _this4 = this;

      var url = 'https://api.apixu.com/v1/current.json?key=0b4ccd28cf7f4c7689d155555173101&q=' + loc.lat + ',' + loc.long;
      ...
      fetch(url).then(function (response) {
        ...
        _this4.errorHandler('Unable to connect to network');
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var form = _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          { onSubmit: this.getLatLong, id: 'port-form' },
          'Search for a location:',
          _react2.default.createElement(
            'div',
            { id: 'location-search-field' },
            _react2.default.createElement('input', { value: this.state.address, onChange: this.handleChange }),
            _react2.default.createElement(
              'div',
              { title: 'Use My Location', id: 'find-me-image' },
              _react2.default.createElement(_myLocation2.default, { onClick: this.findUserLocation })
            )
          ),
          _react2.default.createElement('span', { id: 'weather-error' }),
          _react2.default.createElement(
            'div',
            { className: 'submitBtn' },
            _react2.default.createElement(
      ...
      var results = _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'weather-icon-container' },
          _react2.default.createElement('img', { id: 'weather-icon', src: 'https:' + this.state.icon })
        ),
        _react2.default.createElement(
          'div',
          { id: 'search-again-btn' },
          _react2.default.createElement(
            ...
            { className: 'button', onClick: function onClick() {
                return _this5.setState({ weatherContent: false });
              } },
            'Search Again'
          )
        )
...
var ladderKeys = Object.keys(ladders);
var snakesKeys = Object.keys(snakes);

var SnakesAndLadders = function (_Component) {
  _inherits(SnakesAndLadders, _Component);

  function SnakesAndLadders(pros) {
    _classCallCheck(this, SnakesAndLadders);

    var _this = _possibleConstructorReturn(this, (SnakesAndLadders.__proto__ || Object.getPrototypeOf(SnakesAndLadders)).call(this, pros));
  ...
  _createClass(SnakesAndLadders, [{
    ...
    value: function rollDice() {
      ...
      var sandlCheck = (this.state.p1Score + rndNum).toString();
      ...
      if (this.state.p1Turn) {
        ...
        var _sandlCheck = (this.state.p2Score + rndNum).toString();
        ...
        } else if (ladderKeys.includes(_sandlCheck)) {

          document.querySelector('#landed-on-s-or-l').innerText = 'Player 2! You landed on a ladder and moved up ' + ladders[_sandlCheck] + ' places';

          this.setState({
            p2Score: this.state.p2Score + rndNum + ladders[_sandlCheck],
            p2Turn: false,
            p1Turn: true
          });
        } else if (snakesKeys.includes(_sandlCheck)) {

          document.querySelector('#landed-on-s-or-l').innerText = 'Oh No Player 2! You landed on a snake and moved down ' + snakes[_sandlCheck] + ' places';

          this.setState({
            p2Score: this.state.p2Score + rndNum - snakes[_sandlCheck],
            p2Turn: false,
            p1Turn: true
          });
        } else {
    ...
    value: function render() {
      ...
      var p1Position = function p1Position(i) {
        if (_this2.state.p1Score == i) {
          return 'p1-Circle';
        } else {
          return '';
        }
      };
      var p2Position = function p2Position(i) {
        if (_this2.state.p2Score == i) {
          return 'p2-Circle';
        } else {
          return '';
        }
      ...
      var snakesAndLaddersPositions = function snakesAndLaddersPositions(num) {
      ...
      var board = function board() {
        ...
        if (window.screen.width > 800) {
          for (var i = 0; i < 10; i++) {
            grid.push([]);
            for (var k = 0; k < 10; k++) {
              grid[i].push(_react2.default.createElement(
                'div',
                { className: 'square', id: number, key: number },
                _react2.default.createElement('div', { id: p2Position(number) }),
                _react2.default.createElement(
                  'p',
                  null,
                  number,
                  _react2.default.createElement(
                    ...
                    null,
                    ' ',
                    snakesAndLaddersPositions(number)
                  )
                ),
                _react2.default.createElement('div', { id: p1Position(number) })
              ));
              number--;
            }
          }
        ...
        return grid.map(function (arr, index) {
          return _react2.default.createElement(
            'div',
            { key: index, className: 'board-row' },
            arr
          );
        });
      };
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { id: 'p1', className: 'player-display' },
            _react2.default.createElement(
              'p',
              null,
              'Player 1:'
          ...
          _react2.default.createElement(
            'div',
            { id: 'p2', className: 'player-display' },
            _react2.default.createElement(
              'p',
              null,
              'Player 2:'
          ...
          _react2.default.createElement(
            'div',
            { id: 'score-info' },
            _react2.default.createElement('p', { id: 'roll-dice-info' }),
            _react2.default.createElement('p', { id: 'landed-on-s-or-l' }),
            _react2.default.createElement('p', { id: 'next-player-turn' })
          ),
          _react2.default.createElement(
            'button',
            { className: 'button push_button', onClick: this.rollDice },
            'Roll Dice'
          )
        ),
        _react2.default.createElement(
...
exports.default = SnakesAndLadders;
...
var RndQuote = function (_Component) {
  _inherits(RndQuote, _Component);

  function RndQuote(props) {
    _classCallCheck(this, RndQuote);

    var _this = _possibleConstructorReturn(this, (RndQuote.__proto__ || Object.getPrototypeOf(RndQuote)).call(this, props));
  ...
  _createClass(RndQuote, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { id: 'quote-button', className: 'button push_button', onClick: this.getQuote },
          'Get A New Quote'
        )
      );
    }
...
var _envelope = __webpack_require__(41);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'form',
            { id: 'form', action: 'https://formspree.io/contact@jamesmcgill.co.uk', method: 'POST' },
            'Name:',
            _react2.default.createElement('input', { type: 'text', name: 'name', id: 'name', value: this.state.name, onChange: this.handleChange }),
            _react2.default.createElement('span', { id: 'name-error' }),
            'E-mail:',
            _react2.default.createElement('input', { type: 'email', name: 'email', id: 'email', value: this.state.email, onChange: this.handleChange }),
            _react2.default.createElement('span', { id: 'email-error' }),
            'Message:',
            _react2.default.createElement('textarea', { name: 'message', id: 'message', value: this.state.message, onChange: this.handleChange }),
            _react2.default.createElement('span', { id: 'message-error' }),
            _react2.default.createElement(
              'div',
              { className: 'submitBtn' },
              _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { href: 'https://github.com/jimbomags', target: '_blank' },
...
// module
exports.push([module.i, "nav {\n  width: 100%;\n  margin: 0px;\n  padding: 0px;\n  height: 10vh;\n  display: flex;\n  justify-content: flex-end;\n  flex-wrap: wrap; }\n  nav #links {\n    display: flex;\n    justify-content: space-around;\n    width: 25%; }\n    nav #links a {\n      text-decoration: none;\n      color: #fafafa; }\n      nav #links a:visited {\n        color: #fafafa; }\n\n#burger_icon {\n  margin: 2% 2% 0 0;\n  display: none; }\n  #burger_icon div {\n    width: 40px;\n    height: 5px;\n    background-color: #fafafa;\n    margin: 5px;\n    border-radius: 25px; }\n\n@media screen and (max-width: 800px) {\n  nav {\n    height: auto; }\n    nav #burger_icon {\n      display: block; }\n    nav #links {\n      justify-content: center;\n      flex-flow: column;\n      background-color: #fafafa;\n      width: 100%;\n      padding: 0px;\n      display: none;\n      animation-name: fadeIn;\n      animation-duration: 1s;\n      animation-fill-mode: forwards; }\n      nav #links a {\n        margin: 5px auto 0 auto;\n        color: #3c3c3c;\n        border-bottom: solid 2px #3c3c3c;\n        width: 100%;\n        text-align: center;\n        padding: 8px 0 10px 0; }\n        nav #links a:visited {\n          color: #3c3c3c; } }\n\n#weather {\n  width: 60%;\n  display: flex;\n  justify-content: center;\n  margin: 5% auto auto auto;\n  color: #3c3c3c;\n  font-size: 20px; }\n\n#weather-form-container {\n  display: flex;\n  width: 50%; }\n\n#port-form {\n  margin: auto;\n  width: 100%; }\n  #port-form button {\n    margin-top: 11px; }\n\n#location-search-field {\n  display: flex; }\n\n#find-me-image {\n  height: 25px;\n  margin: 21px 0px 0px 0px; }\n  #find-me-image svg {\n    width: 30px;\n    height: 30px;\n    margin: auto auto auto 5px; }\n  #find-me-image :hover {\n    cursor: pointer; }\n\n#weather-results {\n  display: flex; }\n  #weather-results p {\n    margin: 0 20px 20px 20px; }\n\n#weather-icon {\n  width: 200px;\n  height: 200px; }\n\n#weather-icon-container {\n  display: flex;\n  justify-content: center; }\n\n#search-again-btn {\n  display: flex;\n  justify-content: center; }\n  #search-again-btn button {\n    width: 200px; }\n\n#sandl-container {\n  min-height: 100vh;\n  display: flex;\n  flex-wrap: wrap;\n  animation-name: fadeIn;\n  animation-duration: 2s;\n  animation-fill-mode: forwards;\n  opacity: 0; }\n  #sandl-container #players {\n    position: sticky;\n    position: -webkit-sticky;\n    height: 85vh;\n    top: -1px;\n    width: 12.5%;\n    display: flex;\n    flex-direction: column;\n    margin: 2% 0px; }\n    #sandl-container #players .player-display {\n      display: flex;\n      margin: 3% auto 0 auto;\n      color: #3c3c3c; }\n    #sandl-container #players #p1 div {\n      background-color: red;\n      width: 25px;\n      height: 25px;\n      margin: 10px;\n      border-radius: 25px; }\n    #sandl-container #players #p2 div {\n      background-color: yellow;\n      width: 25px;\n      height: 25px;\n      margin: 10px;\n      border-radius: 25px; }\n    #sandl-container #players #score-info {\n      display: flex;\n      justify-content: center;\n      flex-wrap: wrap;\n      height: 40vh;\n      margin: 40% 0px 0px 0px; }\n      #sandl-container #players #score-info p {\n        text-align: center;\n        color: #3c3c3c; }\n  #sandl-container #board {\n    width: 77.5%;\n    display: flex;\n    flex-wrap: wrap;\n    background-color: white;\n    margin: 2% 0px; }\n    #sandl-container #board .board-row {\n      display: flex;\n      width: 100%; }\n      #sandl-container #board .board-row .square {\n        display: flex;\n        width: 10%;\n        justify-content: center;\n        border: 2px black solid; }\n    #sandl-container #board p {\n      text-align: center;\n      color: black;\n      margin: auto 10px; }\n    #sandl-container #board :nth-child(even) {\n      flex-direction: row-reverse; }\n  #sandl-container button {\n    width: 90%;\n    margin: 0px auto; }\n  #sandl-container #p1-Circle {\n    width: 15px;\n    height: 15px;\n    background-color: red;\n    border-radius: 25px;\n    margin: auto 0px; }\n  #sandl-container #p2-Circle {\n    width: 15px;\n    height: 15px;\n    background-color: yellow;\n    border-radius: 25px;\n    margin: auto 0px; }\n  #sandl-container .push_button {\n    border-right: solid 3px #a64a05;\n    border-bottom: solid 3px #a64a05; }\n    #sandl-container .push_button:active {\n      border-right: solid 3px #ff6e00;\n      border-bottom: solid 3px #ff6e00;\n      border-top: solid 3px #a64a05;\n      border-left: solid 3px #a64a05; }\n\n#quote-container {\n  width: 40%;\n  display: flex;\n  flex-direction: column;\n  margin: 5% auto;\n  animation-name: fadeIn;\n  animation-duration: 2s;\n  animation-fill-mode: forwards;\n  opacity: 0;\n  color: #3c3c3c;\n  font-size: 18px; }\n  #quote-container p {\n    text-align: center; }\n  #quote-container p:nth-child(2) {\n    text-align: right; }\n  #quote-container #quote-button {\n    width: 200px;\n    position: absolute;\n    left: 0;\n    right: 0;\n    margin-top: 200px;\n    margin-left: auto;\n    margin-right: auto;\n    border-right: solid 3px #a64a05;\n    border-bottom: solid 3px #a64a05; }\n    #quote-container #quote-button:active {\n      border-right: solid 3px #ff6e00;\n      border-bottom: solid 3px #ff6e00;\n      border-top: solid 3px #a64a05;\n      border-left: solid 3px #a64a05; }\n\n@media screen and (max-width: 800px) {\n  #sandl-container {\n    min-height: 100vh;\n    display: flex;\n    flex-wrap: wrap;\n    animation-name: fadeIn;\n    animation-duration: 2s;\n    animation-fill-mode: forwards;\n    opacity: 0; }\n    #sandl-container #players {\n      position: sticky;\n      top: 10vh;\n      width: 30%;\n      height: 80vh;\n      display: flex;\n      flex-direction: column;\n      margin: 10vh 0px; }\n      #sandl-container #players .player-display {\n        display: flex;\n        margin: 0 auto;\n        color: #3c3c3c; }\n      #sandl-container #players #p1 div {\n        background-color: red;\n        width: 15px;\n        height: 15px;\n        margin: 20px 10px;\n        border-radius: 25px; }\n      #sandl-container #players #p2 div {\n        background-color: yellow;\n        width: 15px;\n        height: 15px;\n        margin: 20px 10px;\n        border-radius: 25px; }\n      #sandl-container #players #score-info {\n        display: flex;\n        justify-content: center;\n        flex-wrap: wrap;\n        height: 40vh;\n        margin: 20% 0px 0px 0px;\n        font-size: 14px; }\n        #sandl-container #players #score-info p {\n          text-align: center;\n          color: #3c3c3c; }\n    #sandl-container #board {\n      width: 68%;\n      height: 90%;\n      display: flex;\n      flex-wrap: wrap;\n      background-color: white;\n      margin: 2% 5px 2% 0; }\n      #sandl-container #board .board-row {\n        display: flex;\n        width: 100%; }\n        #sandl-container #board .board-row .square {\n          display: flex;\n          width: 25%;\n          height: 50px;\n          justify-content: center;\n          border: 2px black solid; }\n      #sandl-container #board p {\n        text-align: center;\n        color: black;\n        margin: auto 10px; }\n      #sandl-container #board :nth-child(even) {\n        flex-direction: row-reverse; }\n    #sandl-container button {\n      width: 90%;\n      margin: auto auto 10px auto; }\n    #sandl-container #p1-Circle {\n      width: 15px;\n      height: 15px;\n      background-color: red;\n      border-radius: 25px;\n      margin: auto 0px; }\n    #sandl-container #p2-Circle {\n      width: 15px;\n      height: 15px;\n      background-color: yellow;\n      border-radius: 25px;\n      margin: auto 0px; }\n    #sandl-container .push_button {\n      border-right: solid 3px #a64a05;\n      border-bottom: solid 3px #a64a05; }\n      #sandl-container .push_button:active {\n        border-right: solid 3px #ff6e00;\n        border-bottom: solid 3px #ff6e00;\n        border-top: solid 3px #a64a05;\n        border-left: solid 3px #a64a05; }\n  #weather {\n    width: 90%;\n    display: flex;\n    justify-content: center;\n    margin: 5% auto auto auto;\n    color: #3c3c3c;\n    font-size: 20px; }\n  #weather-form-container {\n    display: flex;\n    width: 90%; }\n  #weather-results {\n    display: flex; }\n    #weather-results p {\n      font-size: 14px;\n      margin: 0 20px 20px 20px; }\n  #quote-container {\n    width: 90%; }\n    #quote-container #quote-button {\n      width: 200px;\n      position: absolute;\n      left: 0;\n      right: 0;\n      margin-top: 350px;\n      margin-left: auto;\n      margin-right: auto; } }\n\n@keyframes fadeIn {\n  from {\n    opacity: 0; }\n  to {\n    opacity: 1; } }\n\nhtml, body {\n  margin: 0px;\n  padding: 0px;\n  font-family: 'Source Sans Pro', sans-serif;\n  font-size: 16px;\n  letter-spacing: 0.5px; }\n\n#home_container {\n  width: 100%;\n  min-height: 100vh;\n  display: flex;\n  flex-wrap: wrap;\n  background: linear-gradient(-170deg, #197dff, #64ffff); }\n\n#home {\n  min-height: 90vh;\n  width: 100%; }\n  #home h1 {\n    margin: 17.5vh auto auto 15%;\n    font-size: 55px;\n    font-weight: normal;\n    color: #fafafa; }\n    #home h1 span {\n      font-size: 70px;\n      font-weight: 900;\n      color: white; }\n  #home #about-me-btn {\n    width: 150px;\n    height: 50px;\n    margin: 10% 15%;\n    border-radius: 5px;\n    font-family: 'Source Sans Pro', sans-serif;\n    font-size: 16px;\n    border: none;\n    background-color: #ff6e00;\n    color: white; }\n    #home #about-me-btn:hover {\n      cursor: pointer; }\n    #home #about-me-btn:focus {\n      outline: 0; }\n\n#about {\n  width: 100%;\n  background-color: #fafafa;\n  display: flex; }\n  #about div {\n    width: 50%;\n    margin: 50px auto auto 15%; }\n    #about div p {\n      text-align: justify;\n      line-height: 150%;\n      margin: 30px auto;\n      color: #3c3c3c; }\n\n#skills {\n  width: 100%; }\n  #skills h2 {\n    margin: 5% auto 0px 15%; }\n  #skills #skill-images-container {\n    display: flex;\n    flex-wrap: wrap;\n    margin: 0 10% 5% 15%;\n    width: 50%;\n    justify-content: space-between; }\n  #skills p {\n    color: #3c3c3c; }\n\n.skills {\n  display: flex;\n  flex-wrap: wrap;\n  width: 35%;\n  margin-top: 8%; }\n  .skills img {\n    height: 150px;\n    margin: auto; }\n  .skills p {\n    text-align: center;\n    color: black;\n    width: 100%; }\n\n#portfolio-container {\n  background-color: #fafafa;\n  min-height: 85vh; }\n  #portfolio-container #back {\n    margin: auto auto 30px 3%;\n    padding-top: 10px;\n    font-size: 24px;\n    display: none; }\n    #portfolio-container #back svg {\n      margin: auto 5px auto 0; }\n    #portfolio-container #back:hover {\n      cursor: pointer; }\n\n#portfolio-home {\n  animation-name: fadeIn;\n  animation-duration: 2s;\n  animation-fill-mode: forwards; }\n  #portfolio-home h2 {\n    margin: 0px 0px 3% 15%;\n    padding-top: 3%; }\n  #portfolio-home #port-links-container {\n    display: flex;\n    margin: 0 auto;\n    width: 90%; }\n  #portfolio-home .port-links {\n    width: 90%;\n    height: 200px;\n    margin: 3% auto -160px auto;\n    background-size: cover;\n    background-position: center;\n    color: #3c3c3c;\n    border-radius: 3px 15px 15px 15px;\n    z-index: 3;\n    position: relative;\n    transition: margin-bottom 0.75s, border-radius 0.75s; }\n    #portfolio-home .port-links:hover {\n      margin-bottom: -10px;\n      border-radius: 3px 15px 3px 3px;\n      cursor: pointer; }\n  #portfolio-home .port-info {\n    width: 90%;\n    height: 130px;\n    margin: 0 auto;\n    border-radius: 0 0 15px 15px;\n    background-color: white;\n    z-index: 2;\n    position: relative;\n    display: flex; }\n    #portfolio-home .port-info h3 {\n      margin: auto;\n      color: #3c3c3c; }\n  #portfolio-home #port-quote {\n    background-image: url(" + __webpack_require__(45) + "); }\n  #portfolio-home #port-sl {\n    background-image: url(" + __webpack_require__(46) + ");\n    background-size: 100% 100%; }\n  #portfolio-home #port-weather {\n    background-image: url(" + __webpack_require__(47) + "); }\n  #portfolio-home .link-container {\n    width: 25%;\n    margin: 3% 3%; }\n\nform {\n  margin: 0 auto 0 20%;\n  padding-top: 50px;\n  display: flex;\n  flex-direction: column;\n  width: 40%; }\n  form input, form textarea {\n    margin: 20px auto;\n    width: 100%;\n    height: 25px;\n    font-family: 'Source Sans Pro', sans-serif;\n    font-size: 16px;\n    padding-left: 5px;\n    border: 1px solid grey; }\n  form textarea {\n    height: 100px; }\n  form .submitBtn {\n    display: flex;\n    justify-content: flex-end; }\n    form .submitBtn input {\n      width: 50px;\n      margin: 0px; }\n\n.button {\n  width: 100px;\n  height: 40px;\n  border-radius: 5px;\n  font-family: 'Source Sans Pro', sans-serif;\n  font-size: 16px;\n  border-color: #ff6e00;\n  background-color: #ff6e00;\n  color: white; }\n  .button .send_icon {\n    display: none; }\n  .button:hover {\n    cursor: pointer; }\n  .button:focus {\n    outline: 0; }\n\n.error {\n  height: 25px;\n  width: 99%;\n  background-color: #ac0000;\n  margin-bottom: 20px;\n  padding-left: 2%;\n  color: #fafafa; }\n\n.error-input {\n  border: 2px solid #ac0000;\n  margin-bottom: 0px; }\n\n#contact {\n  width: 100%;\n  min-height: 100vh; }\n  #contact h2 {\n    margin: 3% auto auto 15%; }\n\n#contact-icons {\n  display: flex;\n  justify-content: space-around;\n  width: 40%;\n  margin: 6% auto 10px 20%; }\n  #contact-icons svg {\n    height: 75px;\n    width: 75px;\n    color: #3c3c3c;\n    padding-bottom: 20px; }\n    #contact-icons svg:active {\n      color: #3c3c3c; }\n\n@media screen and (max-width: 800px) {\n  #home_container #home h1 {\n    font-size: 25px;\n    margin-left: 5%;\n    margin-right: 5%; }\n    #home_container #home h1 span {\n      font-size: 31px; }\n  #home_container #home #about-me-btn {\n    margin-top: 35vh;\n    margin-left: 30%;\n    margin-right: 30%;\n    width: 40%; }\n  #about {\n    background-color: #fafafa; }\n    #about div {\n      width: 90%;\n      margin: 50px auto auto 5%; }\n      #about div p {\n        text-align: justify;\n        line-height: 150%;\n        margin: 30px auto;\n        color: #3c3c3c; }\n  #skills h2 {\n    margin: 3% auto 3% 5%; }\n  #skills #skill-images-container {\n    display: flex;\n    flex-wrap: wrap;\n    margin: 0;\n    width: 100%; }\n  .skills {\n    width: 100%; }\n  #portfolio-home h2 {\n    margin-left: 5%; }\n  #portfolio-home #port-links-container {\n    flex-direction: column;\n    padding-bottom: 20px; }\n    #portfolio-home #port-links-container .link-container {\n      width: 80%;\n      margin: auto; }\n    #portfolio-home #port-links-container .port-links {\n      margin-bottom: -10px; }\n    #portfolio-home #port-links-container .port-info h3 {\n      margin: auto;\n      font-size: 16px; }\n  #contact h2 {\n    margin: 3% auto auto 5%; }\n  #contact form {\n    width: 80%;\n    margin-left: 10%; }\n  #contact-icons {\n    display: flex;\n    justify-content: space-around;\n    width: 80%;\n    margin: 15% auto 10px 10%; }\n    #contact-icons svg {\n      height: 75px;\n      width: 75px;\n      color: #3c3c3c;\n      padding-bottom: 20px; }\n      #contact-icons svg:active {\n        color: #3c3c3c; } }\n\n@media screen and (min-width: 451px) and (max-width: 1000px) {\n  #home_container #home h1 {\n    font-size: 55px;\n    margin-left: 5%;\n    margin-right: 5%; }\n    #home_container #home h1 span {\n      font-size: 70px; }\n  #portfolio-home #port-links-container .link-container {\n    width: 60%; } }\n", ""]);
...
module.exports = __webpack_require__.p + "5950bbb27b0ef35876d3ef5c07bab780.jpg";

/***/ }),
/* 46 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "ecb8a9be0c153ecc5aae8ed837a85313.png";

/***/ }),
/* 47 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "6f8f0a1379f61a433b90c34e95789927.jpeg";
