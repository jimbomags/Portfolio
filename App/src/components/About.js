...
const About = () => (
  <div id="about">
    <div>
      ...
      <p>Once I had an understanding of HTML & CSS I moved onto JavaScript. Initially I used Codecademy and Lynda but was struggling to learn from their JS courses. That led me to search other options and I found FreeCodeCamp. I liked FCC because you learn by writing code to complete challenges. You start small such as declaring variables before moving onto more complex algorithms. Another part of FCC’s syllabus is completing projects, which comprised my first <a href="https://decorous-glove.surge.sh" target="_blank" rel="noopener noreferrer">portfolio.</a></p>
